...
export default function CampusShell({children}:{children:React.ReactNode}){
 const pathname=usePathname(); const [mobile,setMobile]=useState(false); const [palette,setPalette]=useState(false); const [query,setQuery]=useState(''); const [selected,setSelected]=useState(0); const [unread,setUnread]=useState(3);
 ...
 return <div className={styles.app}>
  ...
  <main className={styles.main}>
   ...
   <footer className={styles.footer}><span>CampusOS / student workspace</span><nav><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></nav></footer>
  </main>
  <CampusCopilot/>
